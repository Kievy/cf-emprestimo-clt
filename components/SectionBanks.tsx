...
export default function SectionBanks() {
  return (
    <section className="relative w-full overflow-hidden bg-white lg:min-h-[1081px]">
      ...
      >
        <div className="flex flex-col items-center gap-8 pt-16 lg:pt-[104px] w-full" style={{ maxWidth: "856px" }}>
          <div className="flex flex-col items-center gap-4 w-full">
            ...
            >
              ...
              <span style={{ fontWeight: 600, color: C.primary }}>possibilidades.</span>
            </motion.h2>
          </div>
        ...
        >
          <Image src="/images/imagens_bancos.svg" alt="Bancos parceiros" width={576} height={569} className="w-full max-w-[576px]" />
        </motion.div>
      </div>
    </section>
  );
