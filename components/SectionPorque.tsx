...
const col1 = ["Simulação em vários bancos", "Mais liberdade para comparar", "Busca por melhores condições"];
const col2 = ["Atendimento Automatizado", "Suporte em todas as etapas"];

export default function SectionPorque() {
  return (
    <section className="relative w-full overflow-hidden" style={{ backgroundColor: C.primary }}>
      <div
      ...
      >
        ...
        <motion.div
          ...
          style={{ maxWidth: "384px", height: "420px", backgroundColor: C.primaryMid }}
        >
          <Image src="/images/sec10-foto.png" alt="Carol CF Soluções Financeiras" fill className="object-cover object-top" />

          {/* Spinning logo */}
          <div className="absolute w-[72px] h-[72px] lg:w-[109px] lg:h-[109px]" style={{ right: "14px", top: "130px" }}>
            <motion.div
              animate={{ rotate: 360 }}
              transition={{ duration: 14, repeat: Infinity, ease: "linear" }}
              className="w-full h-full"
            >
              <Image src="/images/sec10-logo.svg" alt="CF Soluções Financeiras" width={109} height={109} className="w-full h-full" />
            </motion.div>
          </div>
        </motion.div>
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-4 items-center lg:items-start">
              ...
              <motion.h2
                ...
                style={{ fontFamily: FONT, fontSize: "clamp(24px, 3vw, 40px)", fontWeight: 400, lineHeight: "1.2", color: C.white }}
              >
            ...
            <motion.p
              ...
              style={{ fontFamily: FONT, fontWeight: 400, lineHeight: "1.4", color: C.white }}
            >
              ...
              possa escolher a opção que realmente faz sentido para o seu perfil.
            </motion.p>
          </div>
            ...
            <div className="flex flex-col gap-8 flex-1">
              {col1.map((text) => (
                <motion.div
                  ...
                  style={{ backgroundColor: C.white, border: `1px solid ${C.white}` }}
                >
                  <Image src="/images/sec10-check.svg" alt="" width={24} height={24} className="shrink-0" />
                  <span style={{ fontFamily: FONT, fontSize: "16px", fontWeight: 400, lineHeight: "1.4", color: C.dark }}>{text}</span>
                </motion.div>
              ))}
            </div>
