  ...
  return (
    <section className="relative w-full bg-white">
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-4 items-center lg:items-start">
            ...
            >
              ...
              <span style={{ fontWeight: 600, color: "#24ACE4" }}>margem consignável</span>
            </motion.h2>
          </div>
        ...
        >
          <div
            className="flex flex-col items-center gap-4 px-6 py-10 lg:px-[75px] lg:py-[47px]"
          >
            {/* Icon + wave rings */}
            <motion.div
            ...
            >
              {[0, 0.8, 1.6].map((delay) => (
                <motion.span
                  ...
                  style={{ width: 66, height: 66, backgroundColor: "#24ACE4" }}
